...
-- CreateIndex
CREATE UNIQUE INDEX "AssetTag_workspaceId_name_key" ON "AssetTag"("workspaceId", "name");

-- CreateIndex
CREATE UNIQUE INDEX "AssetTagAssignment_assetId_tagId_key" ON "AssetTagAssignment"("assetId", "tagId");

-- CreateIndex
CREATE UNIQUE INDEX "CardAsset_cardId_assetId_key" ON "CardAsset"("cardId", "assetId");
...
-- AddForeignKey
ALTER TABLE "Card" ADD CONSTRAINT "Card_createdBy_fkey" FOREIGN KEY ("createdBy") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "CardAsset" ADD CONSTRAINT "CardAsset_assetId_fkey" FOREIGN KEY ("assetId") REFERENCES "Asset"("id") ON DELETE CASCADE ON UPDATE CASCADE;
